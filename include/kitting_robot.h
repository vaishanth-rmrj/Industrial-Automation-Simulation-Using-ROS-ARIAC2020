...
class KittingRobot {
    ...
    // Preset locations
        ...
        // - wrist_2_joint
        // - wrist_3_joint
    std::vector<double> arm_preset_at_conveyor = { 1.82, 0.0, -0.85, 1.74, 3.76, -1.58, 0.0};
    ...
    geometry_msgs::Pose conveyor_part_pose;
    ...
    ros::Subscriber conveyor_part_pose_sub;
...
//################# gripper methods ############# 
    ...
    bool pickup_conveyor_part(double part_offset);
...
//############## callback functions ############# 
    ...
    void conveyor_part_pose_sub_callback(const geometry_msgs::Pose::ConstPtr& part_pose);
};
