...
class OrderHandler{
    ...
    ros::ServiceServer assembly_task_completed_srv;
    ...
    bool assembly_task_completed_srv_callback(std_srvs::Trigger::Request &req, std_srvs::Trigger::Response &res);
