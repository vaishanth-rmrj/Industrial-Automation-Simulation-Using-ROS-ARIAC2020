...
#include <group2_rwa4/empty_slot_pose.h>
...
class BinsHandler{
    ...
    ros::ServiceServer empty_bin_slot_pose;
    ...
    std::vector<double> bin5_part_preset_x = {-1.99, -1.99, -1.79, -1.79};
    std::vector<double> bin5_part_preset_y = {-3.47, -3.27, -3.47, -3.27};

    std::vector<double> bin6_part_preset_x = {-1.99, -1.99, -1.79, -1.79};
    std::vector<double> bin6_part_preset_y = {-2.66, -2.46, -2.66, -2.46};

    std::vector<double> bin2_part_preset_x = {-1.99, -1.99, -1.79, -1.79};
    std::vector<double> bin2_part_preset_y = { 2.46,  2.65,  2.46,  2.66};

    std::vector<double> bin1_part_preset_x = {-1.99, -1.99, -1.79, -1.79};
    std::vector<double> bin1_part_preset_y = {3.27,  3.47,  3.27,  3.47};

    double bin_part_preset_z = 0.75;
    ...
    bool empty_bin_slot_pose_callback(group2_rwa4::empty_slot_pose::Request &req, group2_rwa4::empty_slot_pose::Response &res);
